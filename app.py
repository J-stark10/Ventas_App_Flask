...
def init_database():
    ...
    conn.execute("INSERT OR IGNORE INTO clientes (id, nombre) VALUES (4, 'Luis Fernández')")
    conn.execute("INSERT OR IGNORE INTO clientes (id, nombre) VALUES (5, 'Elena Rodríguez')")
    conn.execute("INSERT OR IGNORE INTO clientes (id, nombre) VALUES (6, 'Jorge Sánchez')")
    ...
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (4, 'Monitor', 300)")
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (5, 'Parlantes', 100)")
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (6, 'Cámara', 200)")
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (7, 'Impresora', 150)")
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (8, 'Disco Duro Externo', 90)")
    conn.execute("INSERT OR IGNORE INTO productos (id, nombre, precio) VALUES (9, 'Memoria USB', 20)")
